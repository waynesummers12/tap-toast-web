...
export const metadata = {
  title: "Dirty Soda Bar Littleton | Tap & Toast",
  description:
    "Mobile dirty soda bar catering in Littleton, Colorado. Perfect for weddings, parties, and corporate events. Book Tap & Toast today.",
}

export default function DirtySodaBarLittletonPage() {
  return (
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "Service",
            "name": "Dirty Soda Bar Catering Littleton",
            "areaServed": "Littleton",
            "provider": {
              "@type": "LocalBusiness",
            ...
            "description": "Mobile dirty soda bar catering for events across Littleton, Colorado.",
            "offers": {
              "@type": "Offer",
      ...
      <section className="px-8 py-24 max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center">
        <div>
          <h1 className="text-5xl md:text-6xl font-bold mb-6">
            Dirty Soda Bar Catering in Littleton
          </h1>

          <p className="text-xl max-w-xl opacity-80 leading-relaxed">
            Looking for a dirty soda bar in Littleton? Tap & Toast delivers a fun,
            interactive soda bar experience for weddings, birthday parties, and
            corporate events across the Littleton area.
          </p>
          ...
          <div className="mt-10">
            ...
            >
              Book Your Littleton Soda Bar
            </Link>

            <p className="text-sm text-[#c7a45a] mt-6">
              Serving Littleton events — limited availability on weekends
            </p>
        ...
        <div>
          <Image
            ...
            alt="Dirty Soda Bar Littleton Event"
            width={1200}
            height={700}
      ...
      <section className="px-8 pb-32 max-w-6xl mx-auto">
        <div className="bg-[#c7a45a] text-black p-12 md:p-16 rounded-3xl shadow-[0_20px_60px_rgba(199,164,90,0.3)] text-center">
          ...
          <h2 className="text-3xl font-bold mb-4">
            Book Your Littleton Dirty Soda Bar
          </h2>
