...
export const metadata = {
  title: "Dirty Soda Bar Denver | Tap & Toast",
  description:
    "Mobile dirty soda bar catering in Denver, Colorado. Perfect for weddings, parties, and corporate events. Book Tap & Toast today.",
}

export default function DirtySodaBarDenverPage() {
  return (
    <main className="min-h-screen bg-black text-white selection:bg-[#c7a45a] selection:text-black">
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "Service",
            "name": "Dirty Soda Bar Catering Denver",
            "areaServed": "Denver",
            "provider": {
              "@type": "LocalBusiness",
            ...
            "description": "Mobile dirty soda bar catering for events across Denver, Colorado.",
            "offers": {
              "@type": "Offer",
      ...
      <section className="px-8 py-24 max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center">
        <div>
          <h1 className="text-5xl md:text-6xl font-bold mb-6">
            Dirty Soda Bar Catering in Denver
          </h1>

          <p className="text-xl max-w-xl opacity-80 leading-relaxed">
            Looking for a dirty soda bar in Denver? Tap & Toast delivers a fun,
            interactive soda bar experience for weddings, birthday parties, and
            corporate events across the Denver metro area.
          </p>
          ...
          <div className="mt-10">
            ...
            >
              Book Your Denver Soda Bar
            </Link>

            <p className="text-sm text-[#c7a45a] mt-6">
              Serving Denver events — limited availability on weekends
            </p>
        ...
        <div>
          <Image
            ...
            alt="Dirty Soda Bar Denver Event"
            width={1200}
            height={700}
      ...
      <section className="px-8 pb-16 max-w-6xl mx-auto">
        <p className="text-gray-400">
          Serving Denver and surrounding areas including 
      ...
      <section className="px-8 pb-32 max-w-6xl mx-auto">
        <div className="bg-[#c7a45a] text-black p-12 md:p-16 rounded-3xl shadow-[0_20px_60px_rgba(199,164,90,0.3)] text-center">
          ...
          <h2 className="text-3xl font-bold mb-4">
            Book Your Denver Dirty Soda Bar
          </h2>
